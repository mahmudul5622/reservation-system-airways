...
#include<fstream>
using namespace std;
char l_destination[8][20]={"DHAKA","RAJSHAHI","KHULNA","CHATTAOGRAM","SYLHET","BARISHAL","MYMENSINGH","RANGPUR" };
char i_destination[10][20]={"LONDON","BERLIN","DUBAI","NEW YORK","BEIJING","PARIS","CAPE TOWN","TOKYO","LOS ANGELES","MUMBAI" };
class airline
{
    public:
      virtual const char* getName()
         { return "Sisir";}                      //virtual function
                                                //declared within a base class and redefined by a derived class
};
class Derived: public airline
{
public:
    virtual const char* getName()
    {
...
class Developer {
    ...
    public:
        Developer(): hour(){ }
        friend int func(Developer);        //friend function
};
int func(Developer d){
                                     //function definition
    d.hour=01775117752;                        //accessing private data from non-member function
    return d.hour;
}
class mytime
{
...
public:
    int choose;
    mytime(void);          //constructor FUNCTION  declared
 void getdata()             //constructor is used to initialized the objects of mytime class.
 {
  cout<<"ON WHICH TIME YOU WANT TO TRAVEL"<<endl;
  cout<<"PRESS 1 FOR 11 AM"<<endl;
  cout<<"PRESS 2 FOR 10 AM"<<endl;
  cout<<"PRESS 3 FOR 09 AM"<<endl;
  cout<<"PRESS 4 FOR 09 PM"<<endl;
  cout<<"PRESS 5 FOR 10 PM"<<endl;
 ...
 void show()
 {
  ...
  {
    cout<<"|                                                                         "<<endl;
    cout<<"|flight my time 10 AM                                                        "<<endl;
    cout<<"|_________________________________________________________________________"<<endl;
    cout<<"                  GOOD BYE AND HAVE A SAFE JOURNEY                        "<<endl;
    ofstream outfile;
    outfile.open("E:\\E_ticket.txt",ios::app);
    outfile<<"|                                                                         "<<endl<<
             "|flight my time 10 AM                                                        "<<endl<<
                         "|_________________________________________________________________________"<<endl<<
       "                  GOOD BYE AND HAVE A SAFE JOURNEY                        "<<endl;
  }
  if(choose==3)
  {
    cout<<"|                                                                         "<<endl;
    cout<<"|flight my time 9 AM                                                        "<<endl;
    cout<<"|_________________________________________________________________________"<<endl;
    cout<<"                  GOOD BYE AND HAVE A SAFE JOURNEY                        "<<endl;
    ofstream outfile;
    outfile.open("E:\\E_ticket.txt",ios::app);
    outfile<<"|                                                                         "<<endl<<
             "|flight my time 9 AM                                                        "<<endl<<
                         "|_________________________________________________________________________"<<endl<<
       "                  GOOD BYE AND HAVE A SAFE JOURNEY                        "<<endl;
  }
   if(choose==4)
  ...
  {
    cout<<"|                                                                         "<<endl;
    cout<<"|flight my time 10 PM                                                        "<<endl;
    cout<<"|_________________________________________________________________________"<<endl;
    cout<<"                  GOOD BYE AND HAVE A SAFE JOURNEY                        "<<endl;
    ofstream outfile;
    outfile.open("E:\\E_ticket.txt",ios::app);
...
mytime::mytime()           //constructor defined of mytime class
{
    a=1,b=2,c=3,d=4,e=5;
}
class passenger
...
{
protected:                  //encapsulation (kind of polymorphism)on access specifiers as protected,private,public
                        //encapsulation can be defined as the process of hiding all of the details of an object
 int num;
 char ch;
 char firstname[60];
 char lastname[60];
...
public:
 ...
 void show()
 {
  ...
  cout<<"|_________________________________________________________________________"<<endl;
  cout<<"|Reservation No. :"<<reservation_no<<"                                     "<<endl;
...
public:
 void getdata()
 {
  ...
  cout<<"1)BIMAN BANGLADESH AIRLINE"<<endl;
  ...
  case 1:
   if (option==1)
    cout<<setw(40)<<"\n\n\n                    WELCOME TO BIMAN BANGLADESH AIRLINE "<<endl;
   break;
  case 2:
   if(option==2)
 ...
 public:
  ...
  template<class T, class U = char>   //template generic function.The main advantage of using a
  class A  {                          //template is the reuse of same algorithm for various data types,
  public:                             //hence saving time from writing similar codes.
    T x;
    U y;
    A() {   cout<<"BUSSINESS CLASS IS COMFORTABLE"<<endl;   }
};
 //class member access operator overloading.
 /*Operator overloading is polymorphism type in which a single operator is overloaded to
 give user defined meaning to it. Operator overloading provides a flexibility option for
 creating new definitions of C++ operators.*/
...
main1Overload(int k) //defined operator overloading
{
    menu_choice=k;
}
};
...
{ SetConsoleTitle("AIRWAYS RESERVATION");
 ...
 Sleep(300);
 Derived derived;
 airline &rairline = derived;         //virtual function
 std::cout <<rairline.getName();      //rairline is a reference to the Base portion of a Derived object,
                                     //when rairline.getName() is evaluated, it would normally resolve to airline::getName().
 Developer D;
 cout<<"\n\t\t\t\t\tcontact no: "<<func(D)<<endl;
 Sleep(2000);
 system("CLS");
 main1Overload m1(1);          //overload function obj.
 m1.getdata();
 A<char, char> a;
}
